...
import Neoflex_bank.MS_calculator.dto.CreditDto;
...
import Neoflex_bank.MS_deal.db_pgsql.entity.*;
import Neoflex_bank.MS_deal.db_pgsql.service.ClientServiceDB;
import Neoflex_bank.MS_deal.db_pgsql.service.CreditServiceDB;
...
import static Neoflex_bank.MS_deal.db_pgsql.entity.Statement.eApplicationStatus.STATEMENT_CREATED;
...
public class DealService {
    ...
    public List<LoanOfferDto> processClient(LoanStatementRequestDto request) {
        ...
        addStatementStatusAndUpdate(statement, STATEMENT_CREATED);
        logger.info("Заявка на расчёт обработана");
        return setStatementIds(getOffers(request), statement.getStatement_id());
    }
