...
public class DealService {
    ...
    public void selectOffer(LoanOfferDto request) {
        ...
        EmailMessageDto emailMessageDto = EmailMessageDto.builder()
                .theme(EmailMessageDto.Theme.finishRegistration)
                .address(getEmailByStatementId(statement.getStatementId()))
                .statementId(statement.getStatementId())
                .text("Ваша заявка предварительно одобрена, завершите оформление")
                .build();
        emailService.sendFinishRegistrationEmail(emailMessageDto);
    ...
    public void sendDocuments(LoanOfferDto request, String statementId) {
        ...
        EmailMessageDto emailMessageDto = EmailMessageDto.builder()
                .theme(EmailMessageDto.Theme.sendDocuments)
                .address(email)
                .statementId(statementIdUUID)
                .text("Документы отправлены")
                .build();

        emailService.sendSendDocumentsEmail(emailMessageDto);
    }
